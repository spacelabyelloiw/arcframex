...
- The current visual pass uses a Strikers-style arcade presentation with fixed side HUD panels, pixel-snapped sprites, scanlines, and chunky glowing bullets.
